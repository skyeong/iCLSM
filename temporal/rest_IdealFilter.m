function [Data_Filtered] = rest_IdealFilter(Data, TR, BW)
% FORMAT    [Data_Filtered] = y_IdealFilter(Data, TR, BW)
% Input:
% 	Data   - 2D data matrix (nDimTimePoints * nTimeSeries)
% 	TR     - Sample period, i.e., 1/sample frequency. E.g., TR
%   BW     - The frequency bandwidth for filtering, 1*2 Array. Could be:
%            [LowCutoff_HighPass HighCutoff_LowPass]: BW pass filtering
...
LowCutoff_HighPass = BW(1);
HighCutoff_LowPass = BW(2);
