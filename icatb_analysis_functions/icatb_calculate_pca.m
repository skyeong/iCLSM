function [whitesig, dewhiteM, Lambda, V, whiteM, sumAll] = icatb_calculate_pca(data, numpc, varargin)
...
[V, Lambda, sumAll] = icatb_v_pca(data, 1, numpc, saveEig, 'untranspose', 'no');
